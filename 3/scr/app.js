...
class App{
    ...
    initPages() {
        ...
        groups.CHR = getBtnGroups("颜值", 0, 999999); // 颜值 charm CHR
        groups.INT = getBtnGroups("智力", 0, 999999); // 智力 intelligence INT
        groups.STR = getBtnGroups("体质", 0, 999999); // 体质 strength STR
        groups.MNY = getBtnGroups("家境", 0, 999999); // 家境 money MNY
